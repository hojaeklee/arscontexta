...
SKILL="$PROJECT_ROOT/plugins/hippocampusmd/skills/hippocampusmd-tutorial/SKILL.md"
...
assert_file "$SKILL"
assert_contains "$SKILL" "name: hippocampusmd-tutorial"
assert_contains "$SKILL" "Use when the user asks Codex for a HippocampusMD tutorial"
...
assert_contains "$SKILL" "hippocampusmd-graph"
assert_contains "$SKILL" "hippocampusmd-health"
assert_contains "$SKILL" "hippocampusmd-pipeline"
assert_contains "$SKILL" "hippocampusmd-learn"
