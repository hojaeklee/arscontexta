---
name: arscontexta-session
description: Use when the user asks Codex to orient at session start, validate recent note writes, or capture a session handoff in an Ars Contexta vault.
---
