---
name: arscontexta-archive-batch
description: Use when the user asks Codex to archive a completed Ars Contexta processing batch, clean up completed queue task files, or finish the final pipeline archival phase.
---

# Ars Contexta Archive Batch
