...
description: Use when the user asks Codex to view or manage Ars Contexta task stack, discoveries, queue state, pending work, blocked work, or completed work.
---
