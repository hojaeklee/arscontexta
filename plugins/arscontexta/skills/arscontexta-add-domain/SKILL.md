...
description: Use when the user asks Codex to add a new Ars Contexta knowledge domain to an existing vault, derive domain vocabulary or schema, or preview multi-domain composition.
---
...
- kernel checks and core Ars Contexta invariants
