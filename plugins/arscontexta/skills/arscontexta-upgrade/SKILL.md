...
description: Use when the user asks Codex to compare an existing Ars Contexta vault against current plugin methodology, check generated skill practices, or plan upgrades.
---
