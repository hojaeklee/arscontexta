---
description: Entry point to the HippocampusMD research substrate -- start here to navigate the knowledge graph
type: moc
---

# index

The HippocampusMD research substrate. This vault contains the research claims, operational guidance, and worked domain examples that power the plugin's derivation engine.
