...
- [[orchestrated vault creation transforms hippocampusmd from tool to autonomous knowledge factory]] -- The shift from "plugin that helps you set up a vault" to "system that builds domain knowledge for you" — init creates st
