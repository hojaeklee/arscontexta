...
This is THE key guidance doc for building memory systems on top of HippocampusMD. It tells the plugin HOW to build memory systems that compound over time rather than resetting each session.
