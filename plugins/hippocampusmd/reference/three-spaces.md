...
| `derivation-manifest.md` | Version tracking — hippocampusmd version, research snapshot date, feature blocks enabled, coherence validation results | Semi-permanent — updated during reseed |
