---
name: hippocampusmd-reseed
description: Use when the user asks Codex to analyze HippocampusMD structural drift, re-derive a vault architecture, or plan content-preserving system reseeding.
---

# HippocampusMD Reseed
...
4. Direct smaller incremental changes to `hippocampusmd-architect` or `hippocampusmd-refactor`.
