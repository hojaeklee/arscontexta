---
name: hippocampusmd-reflect
description: Use when the user asks Codex to find meaningful connections between HippocampusMD notes, weave wiki links, or update topic maps/MOCs.
---

# HippocampusMD Reflect
