---
name: hippocampusmd-remember
description: Use when the user asks Codex to capture HippocampusMD learnings, corrections, preferences, friction, session patterns, methodology notes, observations, or tensions.
---

# HippocampusMD Remember
