---
name: hippocampusmd-next
description: Use when the user asks Codex what to do next, what the next best HippocampusMD action is, or how to prioritize vault work.
---
...
```bash
plugins/hippocampusmd/scripts/next-vault.sh . --limit 25 --format text
```
