---
name: hippocampusmd-reduce
description: Use when the user asks Codex to extract durable HippocampusMD notes from source files, inbox items, pasted source material, or raw research/content.
---

# HippocampusMD Reduce
...
- After writing, recommend running `hippocampusmd-validate` on the created or changed notes.
