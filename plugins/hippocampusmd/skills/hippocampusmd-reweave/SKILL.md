---
name: hippocampusmd-reweave
description: Use when the user asks Codex to revisit older HippocampusMD notes, add backward links, repair sparse notes, or update notes with newer vault context.
---

# HippocampusMD Reweave
...
- After edits, recommend running `hippocampusmd-validate` on changed notes.
