---
name: hippocampusmd-rethink
description: Use when the user asks Codex to review accumulated HippocampusMD observations, tensions, methodology drift, or evidence-backed system evolution proposals.
---

# HippocampusMD Rethink
...
- If evidence suggests architecture-level change, recommend `hippocampusmd-architect`, `hippocampusmd-refactor`, or `hippocampusmd-reseed` rather than broad automatic edits.
